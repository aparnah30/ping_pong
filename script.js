...
function DrawPads(Pad1YPos, Pad2YPos) {
    var Pad1 = new Obj(50, Pad1YPos, 35, 100)
    var Pad2 = new Obj(DocWidth - 50, Pad2YPos, 35, 100)
...
function MoveBallLoop(ball) {
    if (ball.x > DocWidth / 2) {
        if (Pad2YPos + 50 > ball.y) {
            Pad2YPos -= 10;
        } else if (Pad2YPos + 50 < ball.y) {
            Pad2YPos += 10;
        }
    }
...
function checkCollision(ballY, ballX) {
    ...
    ballX = ballX + 10
    let LoclPad2XPos = DocWidth - 50 + 12.5
...
//     RequestFrame = false
//     canvas.onclick = () => { }
//     let numberOfPlayers = window.prompt("Enter the number of players (1 or 2):");
//     if (numberOfPlayers === "1") {
//         alert("");
//     } else if (numberOfPlayers === "2") {
//         alert("");
//     } else {
//         alert("Invalid input.enter 1 or 2");
//     }
// }
